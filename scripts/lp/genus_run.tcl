...
set hvl_tech_lef [find [get_db init_lib_search_path]/sky130_fd_sc_hvl/ -name "*.tlef"]
set hvl_cell_lef [find [get_db init_lib_search_path]/sky130_fd_sc_hvl/ -name "*.lef"]
...
set ls_tech_lef [find [get_db init_lib_search_path]/sky130_fd_sc_ls/ -name "*.tlef"]
set ls_cell_lef [find [get_db init_lib_search_path]/sky130_fd_sc_ls/ -name "*.lef"]
...
set lp_cell_lef [find [get_db init_lib_search_path]/sky130_fd_sc_lp/ -name "*.lef"]
...
read_power_intent \
  -1801 \
  -version 3.1 \
  /home/sasha/Downloads/8b10b/tcl/top.upf \
  -module pa_env
